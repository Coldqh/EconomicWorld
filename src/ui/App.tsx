...
import { LineAreaChart, MiniTrendChart, TradingChart } from "./charts.tsx";
...
function Markets({ world, commit, notify }: { world: WorldState; commit: () => void; notify: (text: string) => void }) {
  ...
  const [assetClass, setAssetClass] = useState<"stocks" | "fx" | "bonds" | "indices" | "funds">("stocks");
